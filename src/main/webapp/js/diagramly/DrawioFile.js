...
//		}
		...
		this.ui.editor.setStatus('<div class="geStatusAlert" style="cursor:pointer;overflow:hidden;">' + mxUtils.htmlEntities(mxResources.get('unsavedChangesClickHereToSave')) + '</div>');
     	let num=Number.parseInt(window.sessionStorage.getItem("countNum"))+1
        window.sessionStorage.setItem("countNum",num);
